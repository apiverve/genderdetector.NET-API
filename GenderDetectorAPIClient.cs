...
namespace APIVerve
{
    public class GenderDetectorAPIClient
    {
        ...
        public GenderDetectorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public GenderDetectorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(genderdetectorQueryOptions options)
        {
            try
            {
                if (_isDebug)
